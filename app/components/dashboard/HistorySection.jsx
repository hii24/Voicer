...
function formatTooltip(item) {
  ...
  const lines = [
    ...
    `Auto Pause Enabled: ${settings.auto_pause_enabled ? "true" : "false"}`,
    `Auto Pause Duration: ${settings.auto_pause_duration ?? "-"}`,
    `Auto Pause Frequency: ${settings.auto_pause_frequency ?? "-"}`
  ];
